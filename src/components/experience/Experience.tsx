...
export default function Experience() {
  ...
  return (
    ...
    >
      ...
      {/* Layout principal */}
      <div className="flex flex-col md:flex-row gap-15 max-w-6xl mx-auto px-5 md:px-1 items-center">
        {/* --- Carrossel --- */}
        <div className="relative w-full md:w-2/3 flex items-center justify-center mx-3">
          {/* Wrapper com altura fixa */}
          <div className="w-full flex items-center justify-center overflow-hidden">
            <motion.div
              key={currentIndex}
              className="grid grid-cols-1 w-full md:w-[600px]"
          ...
          <button
            onClick={prevSlide}
            className="hidden md:absolute left-[-1rem] md:left-[-2.5rem] bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white p-2 rounded-full transition cursor-pointer"
          >
            <ChevronLeft size={26} />
          </button>
          <button
            onClick={nextSlide}
            className="hidden md:absolute right-[-1rem] md:right-[-2.5rem] bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white p-2 rounded-full transition cursor-pointer"
          >
        ...
        <div className="w-full md:w-1/3 bg-[#1a1a1a] rounded-2xl p-6 shadow-lg border border-[#2a2a2a] h-[420px] flex flex-col justify-between">
          <div>
